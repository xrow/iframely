...
//var url1 = 'https://www.facebook.com/plugins/post/oembed.json/?url=https%3A%2F%2Fwww.facebook.com%2Fphoto.php%3Ffbid%3D530060777048531%26set%3Da.215094428545169.62692.100001338405848%26type%3D1&format=json';
//console.log(111)
//request({
//    url: url1,
//    headers: {
        ...
        try {
            ...
            var r = request(prepareRequestOptions({
                ...
                headers: {
                    ...
                    'Connection': 'close',
                    'Accept-Encoding': supportGzip ? 'gzip, br' : '',
                    'Accept': '*/*'
                },
                ...
                .on('response', function(res) {
                    ...
                    } else if (supportGzip && (contentEncoding === 'gzip' || contentEncoding === 'deflate')) {
